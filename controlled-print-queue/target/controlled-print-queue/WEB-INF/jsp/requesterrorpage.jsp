    ...
    <div class="detailContainer vv_box_section vv_details">
        <div class="vv_split_column vv_float_left">
          ...
          <div class="fieldRow vv_field_row vv_editable_row">
	        <div class="vv_right_value ">
		      <div class="inputContainer vv_input_field">
				<span selenium-value-name="documentName" class="vv_readonly_text  readonlyVofField">Your controlled document: ${documentName}</span>
		      </div>
	            </div>
          </div>
          <!-- Document Name -->
          <div class="fieldRow vv_field_row vv_editable_row  ">
            <div class="vv_right_value ">
	      <div class="inputContainer vv_input_field">
		<span selenium-value-name="printerName" class="vv_readonly_text  readonlyVofField">An error has occurred and your print request may not have been successful.</span>
	      </div>
       	</div>
        </div>
        <div class="fieldRow vv_field_row vv_editable_row">
